...
**Newly baselines.** 
  - [x] **MTGNN** - Connecting the Dots Multivariate Time Series Forecasting with graph neural networks [[KDD 2020]] [[Code]](https://github.com/thuml/Time-Series-Library/blob/main/models/MTGNN.py).
  - [x] **AGCRN** - Adaptive Graph Convolutional Recurrent Network for traffic forecasting [[NeurIPS 2020]] [[Code]](https://github.com/thuml/Time-Series-Library/blob/main/models/AGCRN.py).
  - [x] **STWA** - Towards Spatio-Temporal Aware Traffic Time Series forcasting [[ICDE 2022]] [[Code]](https://github.com/thuml/Time-Series-Library/blob/main/models/STWA.py).
