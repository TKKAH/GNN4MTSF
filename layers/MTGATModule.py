...
class ConvLayer(nn.Module):
    ...
    :param num_nodes: Number of input nodes
    :param window_size: length of the input sequence
    :param kernel_size: size of kernel to use in the convolution operation
    """

    def __init__(self, num_nodes, kernel_size=7):
...
class GRULayer(nn.Module):
    ...
    def forward(self, x):
        ...
        h = h[-1, :, :]  # Extracting from last layer
        return h
...
class RNNDecoder(nn.Module):
    ...
    def forward(self, x):
        ...
        # decoder_out (batch_size, sequence_length, hidden_size)
        return decoder_out
...
class Forecasting_Model(nn.Module):
    ...
    def forward(self, x):
        ...
        # h_end_rep (batch_size,pred_len,hidden_dim)
